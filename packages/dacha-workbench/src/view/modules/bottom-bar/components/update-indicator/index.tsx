...
export const UpdateIndicator: FC = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribeBuildStart =
      window.electron.onExtensionBuildStart(handleBuildStart);
    const unsubscribeBuildEnd =
      window.electron.onExtensionBuildEnd(handleBuildEnd);
